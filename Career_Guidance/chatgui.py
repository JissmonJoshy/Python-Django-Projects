...
class EnhancedChatbot:
    def __init__(self):
        ...
        self.window = ctk.CTk()
        self.window.title("AI Career Guidance Assistant")
    ...
    def setup_header(self):
        ...
        title_label = ctk.CTkLabel(
            header_frame,
            text="AI Career Guidance Assistant",
    ...
    def run(self):
        ...
        self.append_message("Hello! I'm your AI Career Guidance Assistant. How can I help you today?", "bot")
