...
# license
    ...
    path('approvepassport/',views.approvepassport,name='approvepassport'),
    ...
    path('approvelicense/', views.approvelicense, name='approvelicense'),
    path('rtolicense/', views.rtolicense, name='rtolicense'),
    path('deletelicenserto/', views.deletelicenserto, name='deletelicenserto'),
    ...
    path('verify-otpDeath/<int:id>/', views.verify_otpDeath, name='verify_otpDeath'),
    path('verify-otpPassport/<int:id>/', views.verify_otpPassport, name='verify_otpPassport'),
    path('verify-otpVotter/<int:id>/', views.verify_otpVotter, name='verify_otpVotter'),
    path('verify-otpLisence/<int:id>/', views.verify_otpLisence, name='verify_otpLisence'),
    path('verify-otpMarriage/<int:id>/', views.verify_otpMarriage, name='verify_otpMarriage'),
